    ...
    return (
        isOwnComment ? (
            <div className="action-button-group">
                ...
                <div className="action-button-container" onClick={() => {
                    ...
                    <img
                        ...
                        src={`${process.env.PUBLIC_URL}/images/icon-delete.svg`} alt=""
                    />
                    <span className={'action-button-text delete'}>Delete</span>
                </div>

                <div className="action-button-container" onClick={()=> {onClickHandler('edit')}}>
                    <img className="action-button-icon" src={`${process.env.PUBLIC_URL}/images/icon-edit.svg`} alt="" />
            ...
            <div className="action-button-container" onClick={() => {onClickHandler('reply')}}>
                <img className="action-button-icon" src={`${process.env.PUBLIC_URL}/images/icon-reply.svg`} alt="" />
